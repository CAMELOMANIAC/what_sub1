    ...
    return (
        <>
            {//next.js는 서바사이드와 클라이언트사이드의 절충이라서 리액트처럼 새로고침 한다고 파라메터객체가 클라이언트에서 바로 새로고침 되지않고 서버에서 값을 다시 받아야 새로고쳐진다
                ...
                <div className="absolute w-screen min-w-[1280px] right-0 bg-white border-gray-200 border-b p-10">
                    <div className="flex justify-start w-[1080px] mx-auto">
                        <div className='inline-block w-[100px] overflow-hidden relative rounded-md aspect-square'>
                            <img src={selected[0].image} className='relative object-cover scale-[2.7] origin-[85%_40%]'></img>
                        </div>
