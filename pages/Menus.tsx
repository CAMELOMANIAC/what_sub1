...
export const menuArray: { name: string, image: string, favorit: number, recipes: number, ingredients: Array<string>, matches?: Array<any>, type: number, summary: string }[] = [
    ...
    { name: '스파이시 쉬림프', image: '/images/sandwich_menu/치킨슬라이스샌드위치_20220804012537491.png', favorit: 3, recipes: 1, type: 3, summary: '탱글한 쉬림프에 이국적인 시즈닝을 더해 색다른 매콤함을 만나보세요!',ingredients:['스파이시 쉬림프.jpg','아메리칸 치즈.jpg','랜치.jpg']},
    ...
    { name: '풀드포크', image: '/images/sandwich_menu/Pulled-Pork+cheese_20211231095012512.png', favorit: 3, recipes: 1, type: 3, summary: '미국 스타일의 풀드 포크 바비큐가 가득 들어간 샌드위치',ingredients:['풀드포크 바비큐.jpg','아메리칸 치즈.jpg','스모크바베큐.jpg','랜치.jpg']},
