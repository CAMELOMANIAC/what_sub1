...
export const menuArray: menuArrayType[] = [
	{
		...
		likeRecipe: 0,
		type: 2,
		summary: '오븐에 구워 담백한 저칼로리 닭가슴살의 건강한 풍미',
		ingredients: [
			'치킨 브레스트.jpg',
			'아메리칸.jpg',
			'스위트어니언.jpg',
	...
	},
	{
		...
		likeRecipe: 0,
		type: 2,
		summary: '갓 구운 빵과 신선한 8가지 야채로 즐기는 깔끔한 한끼',
		ingredients: [
			'각종 야채.jpg',
			'아메리칸.jpg',
			'레드와인식초.jpg',
	...
	},
	{
		...
		type: 4,
		summary:
			'부드러운 풀드포크에 매콤한 맛을 더했다!\n 올 겨울 자꾸만 생각 날 매콤한 맛을 써브웨이 스파이시 바비큐로 만나보세요!',
		ingredients: [
			'스파이시 바비큐.jpg',
			'아메리칸.jpg',
			'마요네즈.jpg',
	...
	},
	{
		...
		type: 3,
		summary:
			'담백한 치킨 스트립에\n 달콤짭쪼름한 써브웨이 특제 데리야끼 소스와의 환상적인 만남',
		ingredients: [
			'치킨 데리야끼.jpg',
			'아메리칸.jpg',
			'스모크바베큐.jpg',
	...
	},
	{
		...
		likeRecipe: 0,
		type: 1,
		summary: '풍부한 햄이 만들어내는 담백함을 입 안 가득 즐겨보세요!',
		ingredients: [
			'햄.jpg',
			'아메리칸.jpg',
			'마요네즈.jpg',
...
export const breadNutrientArray: nutrientsArrayType[] = [
	{
		...
		sugars: 5,
		sodium: 0.257,
		summary: '여러 가지 곡물로 만들어 건강하고 고소한 맛의 곡물빵',
	},
	{
		name: '파마산 오레가노',
		weight: 74.5,
...
export const cheeseNutrientArray: nutrientsArrayType[] = [
	...
	},
	{
		...
		sugars: 0,
		sodium: 0.0847,
		summary: '아메리칸 치즈와 몬테레이 치즈가 혼합된 다양한 풍미의 치즈',
	},
	{
		name: '모짜렐라',
		weight: 14,
...
export const sauceNutrientArray: nutrientsArrayType[] = [
	...
	},
	{
		...
		sugars: 8.2,
		sodium: 0.0817,
		summary: '써브웨이만의 특제 레시피로 만든 달콤한 양파소스',
	},
	{
		name: '허니머스타드',
		weight: 21,
		...
		sugars: 6.3,
		sodium: 0.145,
		summary: '겨자씨가 아낌없이 들어간 달콤한 머스터드 소스',
	},
	{
		name: '스위트칠리',
		weight: 21,
		...
		sugars: 9.2,
		sodium: 0.163,
		summary: '말이 필요없는 고소함의 대명사, 마요네즈 소스',
	},
	{
		name: '스모크바베큐',
		weight: 21,
	...
	},
	{
		...
		sugars: 5.3,
		sodium: 0.18,
		summary: '진짜 매운맛을 보고 싶다면? 써브웨이의 핫 칠리!',
	},
	{
		name: '뉴 사우스웨스트 치폴레',
		weight: 21,
	...
	},
	{
		...
		sugars: 0,
		sodium: 0,
		summary: '담백하고 깔끔하게 즐기고 싶다면 주저하지 말고 올리브오일',
	},
];
