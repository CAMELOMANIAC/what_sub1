...
export const menuArray: menuArrayType[] = [
    { name: '로스티드 치킨', image: '/images/sandwich_menu/Roasted-Chicken_20211231095032718.png', favorit: 2, recipes: 1, avgRecipe: 1, type: 2, summary: '오븐에 구워 담백한 저칼로리 닭가슴살의 건강한 풍미', ingredients: ['치킨 브레스트.jpg', '아메리칸.jpg', '스위트어니언.jpg', '올리브오일.jpg'] },
    ...
    { name: '베지', image: '/images/sandwich_menu/Veggie-Delite_20211231095658375.png', favorit: 2, recipes: 1, avgRecipe: 1, type: 2, summary: '갓 구운 빵과 신선한 8가지 야채로 즐기는 깔끔한 한끼', ingredients: ['각종 야채.jpg', '아메리칸.jpg', '레드와인식초.jpg', '올리브오일.jpg'] },
    ...
    { name: '스파이시 쉬림프', image: '/images/sandwich_menu/Spicy_Shrimp_front_20230703125534663.png', favorit: 3, recipes: 1, avgRecipe: 1, type: 3, summary: '탱글한 쉬림프에 이국적인 시즈닝을 더해 색다른 매콤함을 만나보세요!', ingredients: ['스파이시 쉬림프.jpg', '아메리칸.jpg', '랜치.jpg'] },
    ...
    { name: '스테이크 & 치즈', image: '/images/sandwich_menu/Steak-&-Cheese_20211231095455613.png', favorit: 3, recipes: 1, avgRecipe: 1, type: 3, summary: '육즙이 쫙~풍부한 비프 스테이크의 풍미가 입안 한가득', ingredients: ['스테이크.jpg', '아메리칸.jpg', '뉴 사우스웨스트 치폴레.jpg', '마요네즈.jpg'] },
    ...
    { name: '치킨 슬라이스', image: '/images/sandwich_menu/치킨슬라이스샌드위치_20220804012537491.png', favorit: 2, recipes: 1, avgRecipe: 1, type: 2, summary: '닭가슴살로 만든 치킨 슬라이스로 즐기는 담백한 맛!', ingredients: ['치킨 브레스트 햄.jpg', '아메리칸.jpg', '스위트칠리.jpg', '뉴 사우스웨스트 치폴레.jpg'] },
    ...
    { name: '풀드포크', image: '/images/sandwich_menu/Pulled-Pork+cheese_20211231095012512.png', favorit: 3, recipes: 1, avgRecipe: 1, type: 3, summary: '미국 스타일의 풀드 포크 바비큐가 가득 들어간 샌드위치', ingredients: ['풀드포크 바비큐.jpg', '아메리칸.jpg', '스모크바베큐.jpg', '랜치.jpg'] },
    { name: '햄', image: '/images/sandwich_menu/Ham_20211231094833168.png', favorit: 1, recipes: 1, avgRecipe: 1, type: 1, summary: '풍부한 햄이 만들어내는 담백함을 입 안 가득 즐겨보세요!', ingredients: ['햄.jpg', '아메리칸.jpg', '마요네즈.jpg', '홀스래디쉬.jpg'] },
    { name: 'B.L.T', image: '/images/sandwich_menu/B.L.T_20211231094744175.png', favorit: 1, recipes: 1, avgRecipe: 1, type: 1, summary: '오리지널 아메리칸 스타일 베이컨의 풍미와 바삭함 그대로~', ingredients: ['베이컨.jpg', '아메리칸.jpg', '마요네즈.jpg', '뉴 사우스웨스트 치폴레.jpg'] },
