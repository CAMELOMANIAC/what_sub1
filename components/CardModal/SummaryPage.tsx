...
const IngredientsRadarChart = dynamic(() => import("../IngredientRadarChart"), {
      ...
      <div className="grid grid-cols-2">
        <section className="col-span-1">
          ...
          <div className="flex flex-row justify-end mt-auto text-gray-400">
            ...
            >
              {likeRecipe.find((item) => item == recipe.recipe_id) ? (
        ...
        <section className="flex flex-col justify-center col-span-1">
          ...
          />
          <h3 className="text-gray-500 group z-10 left-0 relative">
            <TbAlertCircle />
        ...
        <section className="col-span-2">
          ...
          <div className="flex m-1">
            <textarea
              rows={3}
              placeholder={isLogin ? "바르고 고운 말로 생각을 표현해주세요" : "로그인이 필요한 기능입니다"}
              maxLength={80}
            ...
            ></textarea>
            <button type="submit" className="w-1/6 grow rounded-lg bg-green-600 text-white" onClick={insertReply}>
              댓글 작성
            </button>
          </div>
        </section>
