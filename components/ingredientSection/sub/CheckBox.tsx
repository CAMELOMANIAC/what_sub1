		...
		<li className="h-12 flex items-center">
			<label className="my-auto flex items-center group">
				<BsFillCheckSquareFill
					className={`relative w-6 h-6 mr-2 border rounded group-hover:border-gray-600 group-hover:border ${checked ? 'text-green-600 border-0' : 'text-white '}`}></BsFillCheckSquareFill>
