        ...
        <IngredientsSection ref={ref} id='vegetable'>
            ...
            <ul className='mb-4 p-4'>
                {vegetableArray.map((item) => (
                    <CheckBox key={item.name} name={item.name} addContext='' checked={prop1.array.includes(item.name)} onChange={prop1.onChange}></CheckBox>
                ))}
            ...
            <ul className='p-4'>
                {pickleArray.map((item) => (
                    <CheckBox key={item.name} name={item.name} addContext='' checked={prop2.array.includes(item.name)} onChange={prop2.onChange}></CheckBox>
                ))}
